	...
	RS.prototype.setValues = function (start, end) {
		...
		if (this.conf.range) {
			if (this.conf.tooltip) {
				...
				this.pointerL.innerHTML = this.conf.values[this.values.start];
				this.pointerR.innerHTML = this.conf.values[this.values.end];
			}
	...
	RS.prototype.onChange = function () {
		...
		this.timeout = setTimeout(function () {
			if (_this.conf.onChange && typeof _this.conf.onChange === 'function') {
				return _this.conf.onChange({ 
					targetGroup: `.${_this.conf.target.getAttribute('class')}`, 
					label: _this.conf.target.getAttribute('data-statsfilter'), 
